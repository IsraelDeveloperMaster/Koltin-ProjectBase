...
package net.developermaster.projectbase.estudoUI.estudoUiShop.Helper;
...
public class TinyDB {
    ...
    public ArrayList<ModelUiScreenShopItems> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ModelUiScreenShopItems> playerList = new ArrayList<ModelUiScreenShopItems>();

        for (String jObjString : objStrings) {
            ModelUiScreenShopItems player = gson.fromJson(jObjString, ModelUiScreenShopItems.class);
    ...
    public void putListObject(String key, ArrayList<ModelUiScreenShopItems> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ModelUiScreenShopItems player : playerList) {
